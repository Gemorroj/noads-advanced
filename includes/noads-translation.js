...
var TRANSLATE = function () {
    switch (window.navigator.language) {
        case 'ru': return {
            ...
            iRules: ' \u043f\u0440\u0430\u0432\u0438\u043b \u0434\u043b\u044f ',
            iContinue: ' \u0441\u0430\u0439\u0442\u043e\u0432 \u0431\u0443\u0434\u0443\u0442 \u0438\u043c\u043f\u043e\u0440\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u044b. \u041f\u0440\u043e\u0434\u043e\u043b\u0436\u0438\u0442\u044c?',
        ...
        case 'tr': return {
            ...
            iRules: ' kurallar ',
            iContinue: ' icerik indirilecek. Devam edilsin mi?',
        ...
        case 'fr': return {
            ...
            iRules: ' regles pour le site ',
            iContinue: ' seront importees. Continuer ?',
            iSubs: 'Subscription from %url added %d rules.',
        ...
        case 'pl': return {
            ...
            bElement: 'Zablokowa\u0107 element(y)?',
            iRules: ' regu\u0142 dla ',
            iContinue: ' stron zostanie zaimportowanych. Kontynuowa\u0107?',
            iSubs: 'Subskrypcja z %url dodano %d zasad.',
            iNoDefSub: 'B\u0142\u0105d. Brak domy\u015Blnych subskrypcji',
            ...
            pAddToWhite: 'Dodaj zaznaczenie do bia\u0142ej listy',
            pAllRules: 'Zaimportuj wszystkie regu\u0142y (mo\u017Ce spowalnia\u0107)',
            pAddRules: 'Dodaj regu\u0142y do istniej\u0105cych (mo\u017Ce spowalnia\u0107)',
        ...
        case 'de': return {
            ...
            iRules: ' Regeln f\u00FCr ',
            iContinue: ' Seiten werden importiert. Fortfahren?',
        ...
        default: return {
            ...
            pAbout: EXTNAME + ' v' + VERSION + '\n\nAbout:\nExtension blocks external scripts, specific global script functions and variables, elements of a page and can import subscriptions from CSS-block (Adblock+ format) or URL-block (urlfilter.ini) filter files. While creating general rules you should know that they tend to generate more false-positives while accurate ones will fail more often. Toolbar button on/off switching taking effect when browser restarts.\n\nHotkeys:\nSite preferences - Alt+Shift+P\n\nCreate general rule - Alt+Shift+A\nCreate accurate rule - Alt+Shift+B\nUnblock - Alt+Shift+U\nUnblock latest element - Alt+Shift+L\n\nTo block/unblock several elements use Shift+Click.',
            pBlockingDisable: 'Disable CSS and JS blocking for site',
            pBlockingEnable: 'Enable CSS and JS blocking for site',
